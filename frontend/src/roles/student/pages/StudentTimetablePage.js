...
export default function StudentTimetablePage() {
  ...
  return (
    <div>
      <h3 className="mb-3">My Timetable</h3>
      <div className="card shadow-sm">
        <div className="card-body">
          ...
          {loading ? <div className="alert alert-info">Loading timetable...</div> : null}
                ...
                <tbody>
                  {items.map((t) => (
                    <tr key={t._id}>
                      ...
                      <td className="fw-semibold">{t.module?.code || <span className="text-muted">—</span>}</td>
                      <td>{t.teacher?.user?.name || <span className="text-muted">—</span>}</td>
